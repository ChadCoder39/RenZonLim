    ...
    return (
        <div className="p-10 bg-home_block_1 bg-no-repeat bg-cover bg-center h-[823px]">
            <div className="relative flex flex-col h-full items-center justify-center text-[#eae2d7]">
                <span className="flex items-start text-start justify-start text-[44px] md:text-[76px] ml-0 lg:ml-[-425px] ">{content.n_1}</span>
                <span className="flex items-end text-end justify-end text-[44px] md:text-[76px] mr-0 lg:mr-[-425px]">{content.n_2}</span>

                <span className="absolute top-[200px] md:top-[200px] lg:top-[280px] text-[20px] mr-0 md:mr-[-200px] lg:mr-[-500px] max-w-[400px] text-center md:text-end">{content.n_3}</span>
