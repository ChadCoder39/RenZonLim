...
export default function ContactBlock2() {
  return (
    <div className="relative flex flex-col lg:flex-row items-center justify-center min-h-screen p-10 text-[#322920] max-w-[1400px] mx-auto">
      <div className="absolute top-[-50px] lg:top-[-80px] left-0 w-full text-center z-10">
        <ShiftedTextHeader leftText="APPLY FOR A" rightText="CONSULTATION NOW" />
      </div>
